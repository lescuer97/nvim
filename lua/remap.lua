...
nnoremap( "<C-g>",  "<cmd>lua require('fzf-lua').live_grep_glob({filter = [[rg --invert-match 'node_modules/|build/|archive/|dist/|.git/|package-lock.json|LICENSES.txt|LICENSES.json']]})<CR>") 
